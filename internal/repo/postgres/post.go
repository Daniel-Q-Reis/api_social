...
func (r *PostRepo) GetByAuthorID(ctx context.Context, authorID uuid.UUID, limit, offset int) ([]entity.Post, error) {
	return r.getPosts(ctx, authorID, limit, offset, true)
}

func (r *PostRepo) GetFeed(ctx context.Context, userID uuid.UUID, limit, offset int) ([]entity.Post, error) {
	return r.getPosts(ctx, userID, limit, offset, false)
}

func (r *PostRepo) getPosts(ctx context.Context, userID uuid.UUID, limit, offset int, isAuthorPosts bool) ([]entity.Post, error) {
	var query string
	if isAuthorPosts {
		query = `
